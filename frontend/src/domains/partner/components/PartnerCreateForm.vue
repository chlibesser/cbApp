...
import type { PartnerForm, PartnerStatus } from '../types'
...
async function handleSubmit() {
  ...
  try {
    ...
    const newPartner = await partnerService.createPartner(form)
    
    showSuccess('Partner erfolgreich erstellt')
    ...
    showError(error.response?.data?.message || 'Fehler beim Erstellen des Partners')
  } finally {
